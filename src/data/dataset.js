  ...
  window.dotsMapConfig.dataset || [
    {
      ...
      urls: [
        ...
        {
          linkText: "See more",
          url: "https://medium.com/energy-web-insights/aemo-announces-open-source-operating-system[…]orld-leading-distributed-energy-marketplace-design-a211a6f6c415",
        },
        {
          linkText: "See more",
    ...
    },
    {
      ...
      "": "",
      projectType: "DER Management",
      description: "Decentralized platform for flexibility and balancing",
      linkText: "Learn More",
      urls: [
        {
          linkText: "See more",
    ...
    },
    {
      ...
      urls: [
        {
          linkText: "See more",
          url: "https://medium.com/energy-web-insights/engie-energy-access-and-energy-web-announce-defi-crowdfunding-platform-to-help-scale-solar-mini-2142029ad84f#:~:text=Energy%20Web%20is%20a%20global,participate%20in%20any%20energy%20market",
        },
        {
          linkText: "See more",
    ...
    },
    {
      ...
      projectType: "Traceability",
      description:
        "Production EW Origin Marketplace in compliance with The I-REC Standard in Turkey",
      linkText: "Learn more",
      urls: [
        {
          linkText: "See more",
    ...
    },
    {
      ...
      projectType: "Traceability",
      description:
        "Grant for Energy Web to develop EW Zero, a publicly accessible renewable energy search engine",
      linkText: "Learn more",
      urls: [
        {
          linkText: "See more",
    ...
    },
    {
      ...
      projectName: "Generation Attribute Tracking System (GATS) Bulletin Board",
      location: "US",
      "": "",
      projectType: "Traceability",
      description:
        "PoC that uses the Origin Exchange that is integrated with the PJM GATS registry.",
      linkText: "Learn more",
      urls: [
        {
          linkText: "See more",
    ...
    },
    {
      ...
      "": "",
      projectType: "Traceability",
      description: "Production EW Origin Marketplace in Thailand",
      linkText: "Learn more",
      urls: [
        {
          linkText: "See more",
