  ...
  (
    window.dotsMapConfig.dataset || [
      ...
      },
      {
        ...
        builtWith: ["Energy Web Chain", "DIDs", "Switchboard"],
        urls: [
          {
            linkText: "Learn more",
      ...
      },
      {
        ...
        builtWith: ["Energy Web Chain", "EW Origin"],
        urls: [
          {
            linkText: "Learn more",
      ...
      },
      {
        ...
        projectType: "Traceability",
        description:
          "Zero will be a global search engine for renewable energy certificates and other decarbonization products, that are tokenized on the EW Chain. The goal is to simplify procurement processes, increase transparency about available options, and accelerate decarbonization by matching buyers and sellers across the globe.",
      ...
      },
      {
        ...
        projectType: "Other",
        description:
          "Creating a digital framework for coordinating distributed energy resources (DERs) across the transmission and distribution market interface of Europe’s power grid.",
        builtWith: ["DIDs", "Switchboard", "DSB Messaging", "FlexRunner"],
        urls: [
          {
            linkText: "Learn more",
      ...
      },
      {
        ...
        projectType: "Traceability",
        description:
          "Mercados Eléctricos and EW cooperated to build a pilot digital marketplace for renewable energy certificates in El Salvador to assess a business case for and technical feasibility of a blockchain-based regional I-REC marketplace. Since El Salvador did not have an I-REC market in the beginning of the pilot (2019), Mercados Eléctricos also took a successful lead in establishing The I-REC Standard in the country. In the near future, up to 200 devices in El Salvador are planned to be added to this pilot platform.",
        builtWith: ["Energy Web Chain", "EW Origin"],
        urls: [
          {
            linkText: "Learn more",
      ...
      },
      {
        ...
        projectType: "Traceability",
        description:
          "Testing EWC for blockchain-based matching engine for producers and consumers of renewable energy",
        builtWith: "",
        urls: [
          {
            linkText: "Learn more",
      ...
      },
      {
        ...
        projectType: "Traceability",
        description:
          "Onboarding storage assets on the grid and storing excess renewable energy",
        builtWith: "",
        urls: [
          {
            linkText: "Learn more",
      ...
      },
      {
        ...
        builtWith: ["Energy Web Chain", "EW Origin", "Zero"],
        urls: [
          {
            linkText: "The Energy Origin website",
            url: "https://theenergyorigin.com/",
...
function pairLinkTextToUrl(builtWith) {
  const builtWithUrls = {
    ...
    Switchboard:
      "https://energy-web-foundation.gitbook.io/energy-web/technology/the-stack/application-layer/identity-management-applications#switchboard",
    "IAM Client Lib":
      "https://energy-web-foundation.gitbook.io/energy-web/technology/the-stack/utility-layer-1#identity-access-and-management-iam-client-library",
    "DSB Messaging":
      "https://energy-web-foundation.gitbook.io/energy-web/technology/the-stack/utility-layer-1#decentralized-service-bus-dsb",
    "Cache Server for Blockchain data":
      "https://energy-web-foundation.gitbook.io/energy-web/technology/the-stack/utility-layer-1#identity-access-and-management-iam-cache-server",
    Staking:
      "https://energy-web-foundation.gitbook.io/energy-web/token/staking",
    Watchtower: "",
    "EWNS Name Service":
      "https://energy-web-foundation.gitbook.io/energy-web/how-tos-and-tutorials/using-the-ethereum-name-service-ens",
    "EKC- Enterprise Key Connect": "",
    "Energy Web Chain":
      "https://energy-web-foundation.gitbook.io/energy-web/technology/the-stack/trust-layer-energy-web-chain",
    "EW Origin":
      "https://energy-web-foundation.gitbook.io/energy-web/technology/the-stack/application-layer/clean-energy-traceability-applications#origin-core-sdk",
    FlexRunner: "",
